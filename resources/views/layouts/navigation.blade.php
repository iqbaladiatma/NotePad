<nav x-data="{ open: false }" class="bg-white border-b border-purple-200 shadow-sm font-poppins">
        ...
        <div class="flex items-center justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="flex items-center shrink-0">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo class="block w-auto text-purple-700 fill-current h-9" />
                    </a>
                </div>
            ...
            <div class="flex items-center -me-2 sm:hidden">
                <button @click="open = ! open"
                        class="p-2 text-purple-600 transition duration-150 ease-in-out rounded-md hover:text-purple-800 hover:bg-purple-100 focus:outline-none">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden border-t border-purple-200 sm:hidden bg-purple-50">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="text-purple-700 hover:bg-purple-100">
                {{ __('Dashboard') }}
